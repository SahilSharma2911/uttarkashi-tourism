  ...
  const iconMap = {
    calendar: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" className="w-8 h-8">
        <path fill="#1e0f00" d="M47,44H38V42h8V10H2V42h8v2H1a1,1,0,0,1-1-1V9A1,1,0,0,1,1,8H47a1,1,0,0,1,1,1V43A1,1,0,0,1,47,44Z"></path>
        <path fill="#1e0f00" d="M47,10H1A1,1,0,0,1,0,9V1A1,1,0,0,1,1,0H47a1,1,0,0,1,1,1V9A1,1,0,0,1,47,10ZM2,8H46V2H2Z"></path>
        ...
        <path fill="#1e0f00" d="M24,48A17,17,0,1,1,41,31,17,17,0,0,1,24,48Zm0-32A15,15,0,1,0,39,31,15,15,0,0,0,24,16Z"></path>
        <path fill="#1e0f00" d="M24,35a4,4,0,1,1,4-4A4,4,0,0,1,24,35Zm0-6a2,2,0,1,0,2,2A2,2,0,0,0,24,29Z"></path>
        <rect fill="#1e0f00" x="13.57" y="33.17" width="8.18" height="2" transform="translate(-13.42 11.51) rotate(-26.57)"></rect>
        <rect fill="#1e0f00" x="28.56" y="31.7" width="2" height="9.73" transform="translate(-17.19 31.61) rotate(-45)"></rect>
          ...
          <div className="w-full lg:w-1/3 border border-gray-300 p-3">
            <div className="grid grid-cols-1 gap-6">
              {data.details.map((detail, index) => (
                ...
                >
                  <div className="">{iconMap[detail.icon]}</div>
                  <div className="">
          ...
          <div className="w-full lg:w-1/3 border border-gray-300 p-3">
            <div className="flex flex-col items-center justify-center gap-6">
              <div className="flex items-center justify-center flex-col">
                ...
                <p className="text-gray-600 mt-1 text-xs">{data.pricing.duration}</p>
              </div>
              ...
              <div className="bg-[#1D3827]/5 p-4 text-center">
                ...
                <a
                  ...
                  className="inline-flex items-center justify-center px-10 py-2 bg-[#1D3827] text-white transition-colors text-sm rounded-2xl"
                >
                  Call Now
                </a>
              </div>
